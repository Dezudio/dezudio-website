...
const footerClassName = `
  grid grid-cols-1 tb:grid-cols-12
...
const footerCopyrightClassName = `
  col-span-12 col-start-1 lg:col-start-2
  tb:row-start-3
  pb-0
  text-footer-sm lg:text-footer-base
`;
...
const Footer = () => (
  <div className="bg-blue-dark clear-both">
    <footer className={footerClassName}>
      <section className={footerLogoSectionClassName}>
        <StaticImage
      ...
      <section className={`${footerSectionClassName} lg:col-span-2`}>
        <h2 className={footerHeadingClassName}>Say Hello</h2>
        <address>
          <p>
      ...
      <section className={footerSectionClassName}>
        <h2 className={footerHeadingClassName}>Our Address</h2>
        <address>
          805 Rebecca Avenue
          <br />
          Pittsburgh, PA 15221
      ...
      <section className={`${footerSectionClassName} pb-4 lg:pb-0`}>
        <h2 className={footerHeadingClassName}>Follow Us</h2>
      ...
      <section className={footerCopyrightClassName}>
