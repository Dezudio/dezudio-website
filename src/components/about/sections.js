...
export const TeamsSection = withClasses(
  'section',
  `
auto-rows-min
md:gap-x-16
...
export const AboutSectionP = withClasses(
  'p',
  `
mb-7.5
pb-10 sm:pb-0
...
export const MeetOurTeamSectionBody = withClasses(
  'div',
  `
tb:col-end-5
...
export const MeetOurTeamSectionP = withClasses(
  'p',
  `
pb-10 sm:pb-0
md:pr-1 xl:pr-0
...
export const ProfileContent = withClasses(
  'div',
  `
block lg:flex
justify-between
...
export const ProfileMainSection = withClasses(
  'div',
  `
font-serif-reg
lg:w-60p
...
export const ProfileMainSectionP = withClasses(
  'p',
  `
mb-7.5
pb-10 sm:pb-0
...
export const ProfileSideSection = withClasses(
  'div',
  `
bg-grey-light
font-sans-reg
...
export const UnorderedList = withClasses(
  'ul',
  `
list-disc
pl-6
...
export const UlItem = withClasses(
  'li',
  `
pb-5
last:pb-2.5
